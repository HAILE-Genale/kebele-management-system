...
<body class="print-mode">
    ...
    <div class="certificate-wrapper border-death">
        <div class="cert-inner">
            ...
            <div class="top-meta">
                <div><span>የሞት ክብር መዝገብ ቅጽ ቁጥር / Death Register Form Number: </span><strong><?php echo $cert['certificate_number']; ?></strong></div>
                <div><span>የሞት ምዝገባ ልዩ መለያ ቁጥር / Death Registration Unique ID: </span><strong><?php echo str_pad($cert['person_id'], 8, '0', STR_PAD_LEFT); ?></strong></div>
            </div>
